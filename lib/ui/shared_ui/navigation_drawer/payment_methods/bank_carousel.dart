...
class BankCarousel extends StatefulWidget {
  const BankCarousel({
    Key? key,
  }) : super(key: key);

  @override
  State<BankCarousel> createState() => _BankCarouselState();
}

class _BankCarouselState extends State<BankCarousel> {
  @override
  void initState() {
      ...
      builder: (context, state) {
        return Column(
          children: [
            ...
            SizedBox(
              height: 120,
              child: state.listOfBanks.isEmpty
                  ? Column(
                      children: [
                  ...
                  : MediaQuery.removePadding(
                      ...
                      child: PageView(
                        ...
                        children: _listOfCardWidgets(state.listOfBanks),
                      ),
                    ),
            )
          ],
...
List<Widget> _listOfCardWidgets(List<BankDetail> bankList) {
